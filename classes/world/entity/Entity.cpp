...
void SIM::Entity::Render(GFX::Graphics *gfx, Util::Camera *pCamera) const
{
...
void SIM::Entity::Set_Sprite(std::string newSprite, GFX::Graphics *gfx)
{
...
void SIM::Entity::Set_Active(bool active)
{
	isActive_ = active;
}

void SIM::Entity::Set_Side(Faction side)
{
	side_ = side;
}

bool SIM::Entity::Is_Colliding(const Util::Vector2 *other)
{
...
bool SIM::Entity::Is_Colliding(const Util::Rectangle *other)
{
...
bool SIM::Entity::operator==(Entity &other) const
{
