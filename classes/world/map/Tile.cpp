...
MAP::Tile::Tile(std::string spriteKey, int foodYield, int prodYield) :
...
void MAP::Tile::Render(GFX::Graphics *gfx, Util::Camera *pCamera, const int screenWidth, const int screenHeight) const
{
...
bool MAP::Tile::Add_Feature(MAP::Feature *feature)
{
...
bool MAP::Tile::Add_Resource(Resource *resource)
{
	//Checks that input feature is not nullptr
	if (resource == nullptr) {
		return false;
