...
GFX::Graphics::Graphics() : startOfScreen_(nullptr), screenRect_(0, 0)
{
...
bool GFX::Graphics::Draw_Sprite(const std::string &spriteName, Vector2 pos, bool forceNonAlpha) const
{
